...
?>
<?php
if (isset ($_GET['acetateReportID'])) {
    $selectedDate = $_GET['acetateReportID'];
...
WHERE acetateReport.acetateReportID = $selectedDate";
...
if (isset ($_POST['update'])) {
    ...
    $sql = "UPDATE `tbl_acetatereport` SET Date='$Date', Beginning='$Beginning', Withdrawal='$Withdrawal', ProductPUsage='$ProductPUsage', Cleaning='$Cleaning', Remaining='$Remaining'  WHERE acetateReportID=$selectedDate";
    $result = mysqli_query($con, $sql);
                        ...
                        <div class="initial">
                            <div class="form-column">
                                ...
                                <div class="form-column" style="text-align:center;">
                                    <label>Date:</label>
                                    <input type="date" style="text-align: center; margin-right:54px;" class="styleform"
                                        name="Date" autocomplete="off" value="<?php echo $Date; ?>" required> <br>
                                    ...
                                    <input type="number" style="text-align: center;" class="styleform"
                                        ...
                                        autocomplete="off" value="<?php echo $Withdrawal; ?>" required><br>
